...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Thrice333',		'hawty',		'Director and Artist of Vs Tiff',						'https://twitter.com/Thrice3331', 	'F704B6'], 
			['sn0w_cl0v3r',		'winter',		'Co Artist and Animatior of Vs Tiff',						'',	'04F76E'],
			['Just Jack',		'justjack',		'Main Programmer of Vs Tiff',						'https://twitter.com/Just_Jack6',	'6E6E6B'],
			['Soupy',		'soupy',		'Composer for Vs Tiff',						'https://twitter.com/souplas',	'DEE594'],
			['Crane Carter',		'cranecarter',		'Charter for Vs Tiff',						'https://twitter.com/CraneCarter_',	'D6B2D3'],
			['Viniko',		'viniko',		'Character Offsets',						'',	'2CF704'],
			[''],
			['Psych Engine Team'],
